...
return [function() {
    return {
        ...
        controller: [
                ...
                '$scope', '$route', 'wdSocket', 'internationalAccount', 'wdShare',
                'wdAlert', '$window', 'GA', '$rootScope', 'wdDevice', 'wdDesktopNotification', 'wdUserSettings', 'wandoujiaAccount',
        function($scope,   $route,   wdSocket ,  internationalAccount,   wdShare,
                 wdAlert,   $window,   GA,   $rootScope,   wdDevice,   wdDesktopNotification,   wdUserSettings,   wandoujiaAccount) {
